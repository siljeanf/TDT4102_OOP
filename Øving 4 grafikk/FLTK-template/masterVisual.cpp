...
constexpr double feedback_w = 1.0 - guess_w; // width of field for feedback as fraction of window_width.
                                            //Note how this code is better than setting the value to 0.25
